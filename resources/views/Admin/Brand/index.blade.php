...
@section('page_title') الموديلات @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">الموديلات</h3>
                    ...
                    <div class="{{--table-responsive--}}">
                        <table id="exportexample" class="table table-striped table-responsive-lg  card-table table-vcenter text-nowrap mb-0 table-primary align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <th class="text-white">قطع الغيار</th>
...
@push('admin_js')
    ...
    @include('Admin.SubCategory.parts.ajax',['url'=>'brands','id'=>$sub_category_id])
